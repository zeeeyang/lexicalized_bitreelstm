...
void Sum::forward_impl(const vector<const Tensor*>& xs, Tensor& fx) const {
    ...
    case 1:
        ...
        break;
    case 2:
        res = xs[0]->vec() + xs[1]->vec();
        break;
    case 3:
        res = xs[0]->vec() + xs[1]->vec() + xs[2]->vec();
        break;
    }
...
void SumBatches::forward_impl(const vector<const Tensor*>& xs, Tensor& fx) const {
    ...
    case 0:
        ...
        break;
    case 1:
        res = xs[0]->batch_matrix(0);
        break;
    case 2:
        res = xs[0]->batch_matrix(0) + xs[0]->batch_matrix(1);
        break;
    case 3:
        res = xs[0]->batch_matrix(0) + xs[0]->batch_matrix(1) + xs[0]->batch_matrix(2);
        break;
    }
    for (unsigned i = remainder; i < num_args; i += 4)
